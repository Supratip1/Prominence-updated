        ...
        {!isScoring && scores.length > 0 && (
          <>
            ...
            <div className="space-y-4">
              <h4 className="text-lg sm:text-xl font-semibold text-white flex items-center gap-3">
                    ...
                    >
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                        <div className="flex-1 min-w-0">
                          <h5 className="text-white font-medium text-sm sm:text-base truncate">
                            {asset.title}
                          </h5>
                        ...
                        <div className={`px-3 sm:px-4 py-2 rounded-xl border font-bold text-lg sm:text-xl ${getScoreColor(score.score)}`}>
                          {score.score}
                        </div>
                      </div>
