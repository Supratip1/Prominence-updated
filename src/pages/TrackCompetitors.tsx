                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider text-black hidden md:table-cell">Pages</th>
                        <th className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider text-black hidden md:table-cell">Schemas</th>
                      </tr>
                    </thead>
                      ...
                      {uniqueSortedRanking.map((row: any, index: number) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-2 sm:px-4 md:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm hidden md:table-cell">{details.total_pages_analyzed}</td>
                            <td className="px-2 sm:px-4 md:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm hidden md:table-cell">{details.schema_types_found}</td>
                          </tr>
                        );
                      })}
                    </tbody>
